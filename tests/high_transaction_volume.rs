    ...
    async fn test_high_transaction_volume() {
        ...
        for i in 0..1000 {
            let ix = Instruction::new_with_bincode(
                program_id,
                &PresaleInstruction::Contribute { amount: 10 },
                vec![AccountMeta::new(payer.pubkey(), false), AccountMeta::new(presale_account, false)],
            );
            ...
            assert!(result.is_ok(), "Transaction {} failed", i);
        }
    }
}
